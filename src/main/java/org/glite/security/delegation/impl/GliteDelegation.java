...
public class GliteDelegation {
	...
	/**
	 * The voms validator instance used to validate the voms attribute
	 * certificates.
	 */
	 ...
	 * 
	 * @throws IOException
	 *             Failed to load the DLGEE config file
	 ...
	 * 
	 * @param dlgeeOpt
	 *            the options object for configuring the delegation receiver.
	 */
	 ...
	 * @param certs
	 *            The certificates the user used to authenticate himself.
	 * @return The generated Proxy request in PEM encoding.
	 * @throws DelegationException
	 *             Thrown in case of failures.
	 */
	...
	/**
	 * @param inDelegationID
	 *            The delegation ID used for the delegation.
	 * @param proxy
	 *            The new proxy received from the client.
	 * @param certs
	 *            The certificates the user used to authenticate himself.
	 * @throws DelegationException
	 */
	 ...
	 *            The certificates the user used to authenticate himself.
	 * @param dlgID
	 *            The delegation ID of the new delegation
	 * @param clientDN
	 *            The DN of the owner of the delegated credential
	 * @param vomsAttributes
	 *            The list of VOMS attributes in the delegated credential
	 * @return The certificate request for the new delegated credential
	 * @throws DelegationException
	 *             Failed to create or store the new credential request
	 */
