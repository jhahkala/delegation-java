 ...
 * 
 * <p>
 * It provides a local filesystem archival mechanism for delegated proxies related information.
 * </p>
 * 
 * <p>
 * Storage is separated into two different areas: storage cache and actual storage. The first one holds the temporary
 * information during a delegation request, including the certificate request, the private key and the list of voms
 * attributes expected in the proxy. The second holds the actual delegated proxy information, including the private key
 * and list of voms attributes (as above) and the actual proxy.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * &lt;storage-base-path&gt; is taken from the delegationStorage property inside dlgee.properties.
 * </p>
 * 
...
public class GrDPStorageFilesystem implements GrDPStorage {
     ...
     * 
     * In this case, as it is a filesystem based implementation, the operation is equivalent to an insertion, with the
     * contents of certificate request, private key and list of voms attributes simply being replaced.
     * 
     * @param elem Object containing the information about the delegation request.
     ...
     * @throws GrDPStorageException Could not retrieve a delegation request because either it does not exist or an error
     *             occured while tried to access it.
     */
     ...
     * @throws GrDPStorageException Failed to delete the delegation request as either it does not exist or could not be
     *             accessed.
     */
     ...
     * 
     * In this case, as it is a filesystem based implementation, the operation is equivalent to an insertion, with the
     * contents of delegated certificate, private key and list of voms attributes simply being replaced.
     * 
     ...
     * @return The object containing the information on the delegated proxy. Null is returned if the delegation does not
     *         exist.
     * @throws GrDPStorageException Could not retrieve a delegated proxy because an error occured while tried to access
     *             it.
     */
     ...
     * @throws GrDPStorageException Failed to delete the delegated proxy as either it does not exist or could not be
     *             accessed.
     */
     ...
     * @param fileName The actual file where the contents should be written (userproxy.pem, userreq.pem, userkey.pem,
     *            voms.attributes).
     * @param cache True if storage cache area should be accessed. False if storage area should be accessed.
     * 
     ...
     * 
     * If fileName given is null, the actual directory containing all the related stored credential files is removed.
     * 
     * @param dn The dn of the owner of the delegation request/proxy information.
     * @param dlgID The delegation ID of the delegation request/proxy information.
     * @param fileName The actual file where the contents should be written (userproxy.pem, userreq.pem, userkey.pem,
