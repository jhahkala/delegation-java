...
public class GrDPStorageFilesystem implements GrDPStorage {
     ...
     * 
     * @param elem Object containing the information about the delegation
     *            request.
     * @throws GrDPStorageException Failed to store new delegation request in
     *             storage cache area.
     */
     ...
     * @param elem Object containing the information about the delegation
     *            request.
     * @throws GrDPStorageException Failed to storage new delegation request in
     *             storage cache area.
     */
     ...
     * @throws GrDPStorageException Could not retrieve a delegation request
     *             because either it does not exist or an error occured while
     *             tried to access it.
     */
     ...
     * @throws GrDPStorageException Failed to delete the delegation request as
     *             either it does not exist or could not be accessed.
     */
     ...
     * @throws GrDPStorageException Failed to storage new delegation proxy in
     *             storage area.
     */
     ...
     * @throws GrDPStorageException Failed to store new delegated proxy in
     *             storage area.
     */
     ...
     * @throws GrDPStorageException Could not retrieve a delegated proxy because
     *             either it does not exist or an error occured while tried to
     *             access it.
     */
     ...
     * @throws GrDPStorageException Failed to delete the delegated proxy as
     *             either it does not exist or could not be accessed.
     */
     ...
     * storage areas.
     * 
     * @param dn The dn of the owner of the wanted delegation request/proxy
     *            information.
     * @param dlgID The delegation ID of the wanted delegation request/proxy
     *            information.
     * @param fileName The actual file to be accessed (userproxy.pem,
     *            userreq.pem, userkey.pem, voms.attributes).
     * @param cache True if storage cache area should be accessed. False if
     *            storage area should be accessed.
     * 
     * @return The contents of the requested file.
     * 
     * @throws IOException An error occurred while reading the contents of the
     *             file.
     */
     ...
     * storage areas.
     * 
     * @param dn The dn of the owner of the delegation request/proxy
     *            information.
     * @param dlgID The delegation ID of the delegation request/proxy
     *            information.
     * @param fileName The actual file where the contents should be written
     *            (userproxy.pem, userreq.pem, userkey.pem, voms.attributes).
     * @param cache True if storage cache area should be accessed. False if
     *            storage area should be accessed.
     * 
     * @throws IOException An error occurred while writing the contents to the
     *             file.
     */
    ...
    private void removeFile(String dn, String dlgID, String fileName, boolean cache) throws IOException {
        ...
        if (file.isDirectory()) {
            ...
            for (int i = 0; i < files.length; i++) {
                ...
                if (!result) {
                    throw new IOException("Failed to remove file inside directory '" + files[i].getName()
                            + "'. Directory could/will not be removed.");
                }
            }
        }
